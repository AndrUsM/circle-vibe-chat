import { CenteredVertialLayout, ExtendedReactFunctionalComponent, Message, Show, StackLayout } from "@circle-vibe/shared";
...
> = ({ message }) => {
  ...
  return (
    <CenteredVertialLayout space="0.15rem" className="bg-tertiary rounded-1 p-2">
