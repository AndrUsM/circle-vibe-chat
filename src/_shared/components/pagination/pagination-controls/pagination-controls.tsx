...
export const PaginationControls: ExtendedReactFunctionalComponent<PaginationControlsProps> = ({
  ...
  return (
    <Show.When isTrue={Boolean(paginatedResponse?.totalPages && paginatedResponse?.totalPages > 1)}>
      <CenteredVertialLayout space='0.25rem' className='min-h-8 overflow-y-hidden overflow-x-auto'>
