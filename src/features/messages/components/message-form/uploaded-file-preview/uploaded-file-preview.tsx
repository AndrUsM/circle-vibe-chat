...
export const UploadedFilePreview: React.FC<UploadedFilePreviewProps> = ({
  ...
  return (
    <div className='relative w-fit'>
      <Button className='absolute close-button' size='small' color='secondary' onClick={onClear}>
      ...
      <Show.When isTrue={entityType === MessageFileEntityType.VIDEO}>
        <video muted className='rounded-2 w-full max-w-40 min-h-16' src={fileSource} />
      </Show.When>
