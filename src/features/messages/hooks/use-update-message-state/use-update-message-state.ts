...
export const useUpdateMessageState = () => {
  ...
  const [openMessageUpdateDialog, toggleOpenMessageUpdateDialog] = useBoolean(false);
  ...
  return useMemo(
    ...
    [openMessageUpdateDialog, state, onOpenMessageUpdateDialog, onCloseMessageUpdateDialog],
  );
};
